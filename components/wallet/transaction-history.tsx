    ...
    <div className="bg-card rounded-lg border border-border p-4">
      ...
      <div className="flex flex-col sm:flex-row justify-between mb-4 space-y-2 sm:space-y-0">
        <div className="flex space-x-2">
          <button
            className={`px-3 py-1 rounded-md text-sm flex items-center ${
              filter === "all" ? "bg-emerald-600 text-white" : "bg-muted text-foreground/80"
            }`}
          ...
          <button
            className={`px-3 py-1 rounded-md text-sm flex items-center ${
              filter === "deposit" ? "bg-emerald-600 text-white" : "bg-muted text-foreground/80"
            }`}
          ...
          <button
            className={`px-3 py-1 rounded-md text-sm flex items-center ${
              filter === "withdraw" ? "bg-emerald-600 text-white" : "bg-muted text-foreground/80"
            }`}
        ...
        <div className="flex space-x-2">
          ...
          <button className="p-1 rounded-md hover:bg-muted border">

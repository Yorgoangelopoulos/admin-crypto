        ...
        <div className="text-center">
          <div className="flex justify-center">
            <img
              ...
              className="h-20 w-20 rounded-full object-cover border-2 border-emerald-200 shadow-lg"
            />
          </div>
          <h2 className="mt-4 text-3xl font-bold text-gray-900">Exchange Global</h2>
